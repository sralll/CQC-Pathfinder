...
urlpatterns = [
    ...
    path('infinity-pathing-config/<int:file_id>/', views.get_infinity_pathing_config, name='get_infinity_pathing_config'),
    ...
    path('toggle-infinite/<int:file_id>/', views.toggle_infinite, name='toggle_infinite'),
