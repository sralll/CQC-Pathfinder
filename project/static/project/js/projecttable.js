...
function initButtons() {
    ...
    document.getElementById("nav-create-project")?.addEventListener("click", createFile);
    document.getElementById("nav-copy-project")?.addEventListener("click", copyFile);
    document.getElementById("nav-save-project")?.addEventListener("click", saveFile);
    document.getElementById("create-project-btn")?.addEventListener("click", createFile);
    document.getElementById("save-project-btn")?.addEventListener("click", saveFile);
...
function initProjectTitle() {
    ...
    input.addEventListener("input", () => { project.name = input.value; });
    input.addEventListener("blur", () => {
        if (!input.value.trim()) { project.name = "Neues Projekt"; input.value = project.name; }
    });
}