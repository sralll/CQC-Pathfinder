...
from coursesetter.management.commands.export_media import Command as export_media

urlpatterns = [
    path('export_media/', views.export_media_command, name='export_media_command'),
