...
from coursesetter.management.commands.export_media import download_media_archive as export_media

urlpatterns = [
    path('export_media/', export_media, name='export_media_command'),
